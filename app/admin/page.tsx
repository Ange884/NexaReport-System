      ...
      <div className="lg:col-span-2 space-y-8">
        ...
        <section className="rounded-3xl border border-[var(--border)] bg-white p-6 shadow-sm transition hover:shadow-md">
          <div className="mb-6 flex items-center justify-between">
            ...
            <button className="text-sm font-bold text-[var(--accent)] hover:underline">View All</button>
          </div>
                ...
                {issues.map((issue) => (
                  <tr key={issue.id} className="group transition-colors hover:bg-[var(--background)]">
                    ...
                    <td className="py-4 text-right">
                      <button className="rounded-lg border border-[var(--border)] px-4 py-1.5 text-xs font-bold text-[var(--muted)] transition-all hover:border-[var(--accent)] hover:text-[var(--accent)] hover:bg-white">
                        Manage
                      </button>
                    </td>
                  </tr>
      ...
      <div className="space-y-6">
        ...
        <div className="relative mt-4 overflow-hidden rounded-3xl  bg-[var(--accent)] p-6 text-white shadow-xl">
          <div className="relative z-10">
            ...
            <button className="mt-6 flex w-full items-center justify-center rounded-xl bg-white/20 py-3 text-sm font-bold backdrop-blur-md transition-all hover:bg-white/30">
              Take Action Now
            </button>
          </div>
        </div>
